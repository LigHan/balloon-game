...
with tempfile.TemporaryDirectory(prefix="balloon-http-") as temp:
    ...
    try:
        ...
        for route in ["/", "/admin", "/presentation", "/style.css", "/app.js", "/request-id.js", "/admin.js", "/presentation.js", "/assets/balloon.png", "/assets/stoloto-logo.png", "/assets/roboto-flex.woff2", "/assets/favicon.svg"]:
